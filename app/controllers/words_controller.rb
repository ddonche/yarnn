class WordsController < ApplicationController
  ...
  def generate_ipsum
    ...
    words = [ 
      ...
      "cowboy", "cracker", "crawdad", "creek", "Creole", "cross", "Cuda",
      ...
      "Tabasco", "tackle", "tackle box", "tadpole", "tarnation", "tater", "Texas", "these parts", "throttle", "ticks",
    ...
    @generated = ran_capital1 + " " + ran_words1.delete('"') + ". " + ran_capital2 + " " + ran_words2.delete('"') + ". " + ran_capital3 + " " + ran_words3.delete('"') + "."
    ...
    @generated2 = fallout_caps1 + " " + fallout1.delete('"') + ". " + fallout_caps2 + " " + fallout2.delete('"') + ". " + fallout_caps3 + " " + fallout3.delete('"') + "."
